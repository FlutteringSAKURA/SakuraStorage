...
// Update: //@ 2023.12.18 
//# NOTE: The Dark Forest Secene Camera의 전반을 관리하기 위한 스크립트

//~ -------- PROJECT : Bramble-The Kong And Pat ----------------------------------------
public class TheDarkForestCamera : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            float _moveYaxis = _moveSpeed * Time.deltaTime;
            transform.Translate(0, -_moveYaxis, 0);
        }
